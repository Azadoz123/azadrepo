...
using Allegory.Module.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(ModuleBlazorServerModule)
)]
public class ModuleBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(ModuleDomainModule).Assembly,
                typeof(ModuleDomainSharedModule).Assembly,
                typeof(ModuleApplicationModule).Assembly,
                typeof(ModuleApplicationContractsModule).Assembly,
                typeof(ModuleBlazorHostModule).Assembly
            );
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Allegory.Module.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<ModuleBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(ModuleBlazorHostModule).Assembly;
        });
